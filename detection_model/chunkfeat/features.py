"""Deterministic, leakage-resistant chunk features.
...
from detection_model.corefeat.features import (
...
def feature_implementation_sha256() -> str:
    ...
    dependencies = (
        ...
        project_root / "detection_model" / "corefeat" / "features.py",
        project_root / "detection_model" / "corefeat" / "schema.py",
